            ...
            <div id="price_labels_data" class="gforms-panel panel woocommerce_options_panel" <?php echo empty($gravity_form_data['id']) ? "style='display:none;'" : ''; ?>>
                ...
                <div class="options_group">
                    ...
                    woocommerce_wp_text_input(array('id' => 'gravityform-price-after', 'label' => __('Price After', 'wc_gravityforms'),
                        ...
                        'placeholder' => '', 'description' => __('Enter text you would like printed after the price of the product.', 'wc_gravityforms')));
                    ?>
                </div>
            </div>
                ...
                if (!empty($form_meta)) {
                    ...
                    foreach ($form_meta['fields'] as $field) {
                        ...
                        if (!empty($value) && !empty($arr_var)) {
                            ...
                            $other_data[] = array('name' => $display_title, 'display' => $display_value, 'value' => $display_value);
                        }
                    }
                }
            }
                        ...
                        foreach ($form_meta['fields'] as $field) {
                            ...
                            if (!empty($value) && !empty($arr_var)) {
                                try {
                                    ...
                                    woocommerce_add_order_item_meta($item_id, $display_title, $display_value);
                                } catch (Exception $e) {
