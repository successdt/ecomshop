...
// Plugin loaded
add_action( 'plugins_loaded', array( 'WC_Compare_Functions', 'plugins_loaded' ), 20 );
...
// Upgrade to 2.0.6
if(version_compare(get_option('a3rev_woocp_pro_version'), '2.0.7') === -1){
	WC_Compare_Functions::upgrade_version_2_0_7();
...
function woocp_add_menu_item_e_commerce() {
	...
	$comparable_settings_page = add_submenu_page( $woo_page , __( 'Compare Settings', 'woo_cp' ), __( 'Product Comparison', 'woo_cp' ), 'manage_woocommerce', 'woo-compare-settings', 'woo_cp_dashboard' );
...
?>
    ...
    <div class="wrap">
    	<?php if(isset($_POST['woocp_pin_submit'])) echo '<div id="message" class="updated fade"><p>'.get_option("woo_compare_message").'</p></div>'; ?>
