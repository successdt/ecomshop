...
?>
	...
	<div>		
		...
		<ul>
			<li>
				* From the <b>theme html</b> use: <code>&lt?php putRevSlider( "alias" ) ?&gt</code> example: <code>&lt?php putRevSlider(<?php echo $exampleID ?>) ?&gt</code>
				<br>
				&nbsp;&nbsp; For show only on homepage use: <code>&lt?php putRevSlider(<?php echo $exampleID ?>,"homepage") ?&gt</code>
				<br>&nbsp;&nbsp; For show on certain pages use: <code>&lt?php putRevSlider(<?php echo $exampleID ?>,"2,10") ?&gt</code>
			</li>
