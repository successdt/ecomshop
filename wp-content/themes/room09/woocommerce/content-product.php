...
// force open hover
if ( $woocommerce_loop['layout'] != 'classic' ) $woocommerce_loop['li_class'][] = ( ! yit_get_option( 'shop-open-hover' ) ) ? 'add-hover' : 'force-open';
...
/*    		do_action( 'woocommerce_before_shop_loop_item_title' );
        ...
        <div class="product-meta">
            <div class="product-meta-wrapper">
            	...
            	<?php
            	    if ( ! is_shop_enabled() || ! yit_get_option( 'shop-view-show-price' ) )  remove_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_price' );
            	    if ( ! yit_get_option( 'shop-view-show-rating' ) ) remove_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating', 5 );
...
/**
 * modify by thanhdd@ecomwebpro.com
 */
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
