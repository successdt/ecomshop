    ...
    public function change_args( $args ) {
        return array(
            'settings' => array(
                ...
                array(
                    'desc' => __( 'Publish the accordion to configure it.', 'yit' ),
                    'type' => 'simple-text',
            ...
            'labels' => array(
                'singular_name' => __( 'Accordion', 'yit' ),
                'plural_name' => __( 'Accordions', 'yit' ),
                'item_name_sing' => __( 'Item', 'yit' ),
                'item_name_plur' => __( 'Items', 'yit' ),
            ),
 ...
 * @since 1.0.0
 */
function yit_accordion_typography_options( $portfolio_type = '', $options ) {
    yit_get_model('accordion')->add_typography_options( $portfolio_type, $options );
}    
