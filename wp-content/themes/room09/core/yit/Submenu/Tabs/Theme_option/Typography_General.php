        ...
        return array(        	
            1 => array(
                ...
                'style' => apply_filters( 'yit_general-font_style', array( // <-- by piero: aggiunto filtro per poter aggiungere altri selettori in theme
					'selectors' => 'p, li, address, dd, blockquote, td, th, .paragraph-links a, a.text-color, .text-color',     // <-- by antonino: ho aggiunto a.text-color e .paragraph-links a, per far in modo di dare il stess colore del testo ai link che hanno classe "text-color"
            ...
            70 => array(
                ...
                'style' => apply_filters( 'yit_special-font_style', array(
