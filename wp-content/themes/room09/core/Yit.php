...
final class YIT {
	...
	/**
	 * The classes to add in the body tag 
	 *     	
	 * @var array
	 */
	...
	public function init() {
		...
		// help the developers to add the classes to body
	...
	public function add_body_class( $class ) {
		$this->_bodyClasses[] = sanitize_html_class( strtolower($class) );
	}
	...
	public function output_body_class( $classes ) {
		if ( sizeof( $this->_bodyClasses ) == 0 ) return $classes;
        
        return array_merge( $classes, $this->_bodyClasses );
	}
}
