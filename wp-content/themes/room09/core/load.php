...
define( 'YIT_THEME_I18N_URL', 	    YIT_THEME_URL . '/languages' );
define( 'YIT_THEME_FUNC_URL', 	    YIT_THEME_URL . '/theme' );
define( 'YIT_THEME_CSS_URL', 	    YIT_THEME_URL . '/css' );
define( 'YIT_THEME_JS_URL', 	    YIT_THEME_URL . '/js' );
define( 'YIT_THEME_IMG_URL', 	    YIT_THEME_URL . '/images' );
...
define( 'YIT_CACHE_DIR', get_stylesheet_directory() . '/cache' );
define( 'YIT_CACHE_URL', get_stylesheet_directory_uri() . '/cache' );
...
load_theme_textdomain( 'yit', YIT_THEME_I18N_DIR );
