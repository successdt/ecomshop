							...
							<?php if( $this->image || $this->message || $this->newsletter) : ?>
								<div class="row">
									<?php if($this->image) : ?>
                                        ...
                                        ?>
									    <div class="popup_img <?php echo ($this->message || $this->newsletter) ? "span2" : "span5" ?>"><img alt="popup-image" src="<?php echo $this->image ?>" <?php echo $size ?> /></div>
									<?php endif ?>
										...
										?>
										    ...
										    <div class="popup-newsletter-section group">
										        <form method="<?php echo $method ?>" action="<?php echo $action ?>">
										            <fieldset class="row">
										                <ul class="group">
										                    <li class="<?php if(!$this->image) : ?>offset2<?php endif ?>">
