    ...
    public function init() {  
        return array(
            ...
            60 => array(
                ...
                'type' => 'onoff',
                'name' => __( 'Show details icon (in classic layout)', 'yit' ),
                'desc' => __( 'Say if you want to show the details icon.', 'yit' ),
            ...
            61 => array(
                ...
                'desc' => __( 'Say if you want to show the wishlist icon (only for "Popup" style).', 'yit' ),
                'std'  => apply_filters( 'yit_shop-view-show-wishlist_std', 1 )
            ),    
            62 => array(
                'id'   => 'shop-view-show-compare',
                'type' => 'onoff',
                'name' => __( 'Show compare icon', 'yit' ),
                'desc' => __( 'Say if you want to show the compare icon (only for "Popup" style).', 'yit' ),
            ...
            63 => array(
                ...
                'desc' => __( 'Say if you want to show the share icon (only for "Popup" style).', 'yit' ),
            ...
            65 => array(
                ...
                'std'  => apply_filters( 'yit_shop-share-lite-style_std', 1 )
            ),
            70 => array(
            ...
            110 => array(
                'id'   => 'shop-open-hover',
                'type' => 'onoff',
                'name' => __( 'Force open hover (in "Popup" style")', 'yit' ),
                'desc' => __( 'Force to open the hover box, in "Popup" style grid.', 'yit' ),
