...
function yit_tab_general_settings( $fields ) {
	...
	$fields[110] = array(
        'id'   => 'sidebar-home-position',
        'type' => 'select',
        'name' => __( 'Position of sidebar "Home Row" (only with Home template)', 'yit' ),
        'desc' => __( 'Select the position of the "Home Row" sidebar when the page have the "Home" template selected.', 'yit' ),
        'options' => array(
            'top' => __( 'Top', 'yit' ),
