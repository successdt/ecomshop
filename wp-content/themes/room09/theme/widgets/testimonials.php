...
class testimonials extends WP_Widget 
{
    ...
    function widget( $args, $instance ) 
    {
        ...
        {
            echo '<div class="testimonial-widget-span span3">';
			echo $before_widget;
                ...
                {                          
                    ...
                    echo '<li>';
                        echo '<div>';
                            ...
                            $website = get_post_meta( get_the_ID(), '_site-url', true );
                            ...
                            the_post_thumbnail( 'thumb-testimonial', array( 'class' => 'thumbnail' ) );
                            the_title( '<div class="name-testimonial">
                            <a class="name-testimonial" href="' . get_permalink( get_the_ID() ) . '">', '</a>' . $website . '</div>' );
