...
<div id="page-meta" class="group margin-top">
        ...
        elseif( is_archive() ) :
            if( yit_get_option( 'show-title-archives' ) ) :
                if( is_tag() ) : ?>
                    ...
                    <<?php echo $tag_title ?>><?php echo apply_filters( 'yit_archive_author_title', __( 'Author archive', 'yit' ) ) ?></h1>
                <?php
                endif;
            endif;
    ...
    <?php if ( $show_breadcrumb && ( ! function_exists('is_shop') || ! is_shop() && !is_product() ) ) : ?>
        <!-- BREDCRUMB -->          
