...
<h3 id="comments-title">
    <?php comments_number( __('No replies', 'yit'), __('1 reply', 'yit'), __('% replies', 'yit') ); ?>
</h3>
<?php
...
$comment_args = array(
	...
	'comment_field'        => '<p class="comment-form-comment"><!--<label for="comment">'. __( 'Your comment', 'yit' ).'</label><i class="icon-pencil"></i>--><textarea id="comment" name="comment" cols="45" rows="8" placeholder="'.__( 'Comment', 'yit' ).'"></textarea></p><div class="clear"></div>',
