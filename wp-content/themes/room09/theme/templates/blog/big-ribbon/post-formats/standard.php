...
$span = yit_get_sidebar_layout() == 'sidebar-no' ? yit_get_option( 'blog-show-date' ) || yit_get_option( 'blog-show-comments' ) && comments_open() ? 11 : 12 : 8;
...
<div class="<?php if ( ! $has_thumbnail ) echo 'without ' ?>thumbnail span<?php echo $span ?>">
    ...
    <?php
    if( $has_thumbnail ) {
        yit_image( "size=blog_big_ribbon&alt=blogimage" );//the_post_thumbnail( 'blog_big_ribbon' );
    }
    ?>
